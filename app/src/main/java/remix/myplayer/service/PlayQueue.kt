...
class PlayQueue(service: MusicService) {
    ...
    fun makeList() {
        ...
        LogUtils.v("makeList, size: ${_playingQueue.size}")
    }
    ...
    private fun makeNormalList() {
        ...
        LogUtils.v("makeNormalList, queue: ${_playingQueue.size}")
    }
    ...
    private fun makeShuffleList() {
        ...
        LogUtils.v("makeShuffleList, queue: ${_playingQueue.size}")
    }
    ...
    private fun setUpDataSource(lastSong: Song?, pos: Int) {
        ...
        //初始化当前播放歌曲
        LogUtils.v("当前歌曲:%s", lastSong.title)
        song = lastSong
        position = pos
        updateNextSong()
    }
    ...
    fun updateNextSong() {
        ...
        LogUtils.v("updateNextSong, curPos: $position nextPos: $nextPosition nextSong=${nextSong.title}\n }")
    }
