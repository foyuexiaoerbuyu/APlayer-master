...
//    }
    ...
    fun init(context: Context, sessionId: Int, force: Boolean = false): Boolean {
        LogUtils.v("init, audioSessionId: $sessionId")
    ...
    fun open(context: Context, audioSessionId: Int) {
        LogUtils.v("open, audioSessionId: $audioSessionId")
...
//      }
            ...
            LogUtils.v("min: $minLevel max: $maxLevel bandNumber: $bandNumber")
        }
    }
